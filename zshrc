...
export PATH=$HOME/bin:$HOME/.local/bin:/usr/local/bin:$PATH:/opt/homebrew/bin:/bin/bash:$HOME/.bun/bin:$PATH
...
#
#
alias esketchybar='vim ~/.config/sketchybar/sketchybarrc'
alias eterm='vim ~/.wezterm.lua'
alias eaero='vim ~/.config/aerospace/aerospace.toml'
